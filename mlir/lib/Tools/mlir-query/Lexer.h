...
#ifndef MLIR_TOOLS_MLIRQUERY_PARSER_LEXER_H_
#define MLIR_TOOLS_MLIRQUERY_PARSER_LEXER_H_
...
class Lexer {
public:
  Lexer(const StringRef &curBuffer) : curBuffer(curBuffer) {
...
#endif // MLIR_TOOLS_MLIRQUERY_PARSER_LEXER_H_
